...
const SLUG_NAMES: Record<string, string> = {
  ...
  'kitchen-ventilation-startup-commissioning': 'Startup & Commissioning',
  'kitchen-hood-performance-testing': 'Hood Performance Testing',
  'commercial-kitchen-ventilation-startup-checklist': 'Ventilation Startup Checklist',
...
export default function Breadcrumbs() {
  ...
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-7xl mx-auto px-4 lg:px-6 py-4">
