...
const schemaMarkup = {
  ...
  areaServed: ['New York City', 'Elizabeth', 'Newark', 'Jersey City', 'Northern NJ'],
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 relative">
          <Reveal>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <a href="tel:+16469429394" className="inline-flex items-center justify-center gap-2 border border-white/10 hover:border-amber-500/30 text-white font-medium text-base px-8 py-4 rounded-xl transition-all">
      ...
      <Section className="bg-red-500/[0.03]">
        ...
        <Reveal delay={200}>
          <p className="text-center mt-8 text-sm text-slate-500 max-w-2xl mx-auto">
            Beyond NYC, Northern NJ landlords in mixed-use buildings and property management companies increasingly require ESPs in commercial leases to control odors and grease discharge.
          </p>
        </Reveal>
      </Section>
      ...
      <Section>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {[
            ...
            { q: 'Do I need an ESP for my Northern NJ restaurant?', a: 'Even outside NYC\'s Local Law 38, many Northern NJ landlords and property management companies require ESPs in commercial kitchen leases to control grease and odor discharge, especially in mixed-use buildings and shopping centers. Local ordinances and neighbor complaints can also drive the requirement.' },
      ...
      <Section className="bg-white/[0.02]">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {['Manhattan', 'Brooklyn', 'Queens', 'The Bronx', 'Staten Island', 'Elizabeth', 'Newark', 'Jersey City', 'Paterson', 'Union County'].map((area, i) => (
