        ...
        <div className="max-w-3xl mx-auto">
          <Reveal>
            ...
            <div className="space-y-4 text-slate-400 leading-relaxed text-sm">
              <p>{loc.description}</p>
              <p>True Commercial Service provides expert repair for commercial cooking equipment, refrigeration systems, HVAC, beverage dispensing equipment, and commercial espresso machines across {loc.serviceArea.join(', ')}{loc.state === 'OK' ? ' and surrounding communities in Central Oklahoma' : loc.state === 'NJ' ? ' and the greater NYC metro area' : loc.state === 'NY' ? ' and the five boroughs of New York City' : ' and North Georgia'}.</p>
