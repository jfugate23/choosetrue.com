          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/20 rounded-full px-4 py-1.5 mb-6 animate-fade-in">
                ...
                <span className="text-amber-300 text-xs font-medium tracking-wide">NOW SERVING NORTHERN NJ &bull; NYC &bull; CONNECTICUT</span>
              </div>
              ...
              <p className="mt-6 text-lg lg:text-xl text-slate-400 leading-relaxed max-w-lg animate-fade-up" style={{ animationDelay: '0.1s' }}>
                Commercial kitchen equipment repair backed by real diagnostics, transparent tracking, and techs who actually know your equipment.
              </p>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4 animate-fade-up" style={{ animationDelay: '0.2s' }}>
                ...
                <a href={COMPANY.emergencyPhoneHref} className="inline-flex items-center gap-2 text-slate-300 hover:text-white transition-colors font-medium">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href={COMPANY.phoneHref} className="text-lg font-semibold hover:text-amber-400 transition-colors">{COMPANY.phone}</a>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href={COMPANY.emergencyPhoneHref} className="text-lg font-semibold hover:text-amber-400 transition-colors">{COMPANY.emergencyPhone}</a>
                </div>
              </div>
            </div>
          </div>
